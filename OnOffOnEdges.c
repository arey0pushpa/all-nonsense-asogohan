...
int  main()
 ...
 {    
    ...
    snareVector total, cond2Total, cond2fareTotal, centTotal, placeHolder, v, v1, vl, vl2, t, f, v2, lastv, lastv2 ,nv, nv2, v0, v02 ;
    snareVector Tedge[N][N], Vedge[N][N] , Vedge2[N][N] , Tedge2[N][N] , fComp , bComp;    
    snareVector friendMatrix[snareLength];     
    snareVector onOffMatrix[N], xtraOff[len],stCorres , off;
